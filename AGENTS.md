...
- End-to-end tests live under `armada/e2e/fix-global-link/`. Only qa writes there.
- Screenshots live under `armada/screenshots/fix-global-link/`.
...
## armada/ledgers/fix-global-link/DEFECTS.md — the defect ledger

All defects live in `armada/ledgers/fix-global-link/DEFECTS.md`, one entry per defect, newest
...
Format, exactly:
    ...
    Screenshot: armada/screenshots/fix-global-link/def-001.png (optional)
...
## armada/ledgers/fix-global-link/ADVERSARIAL_REVIEW.md — the adversary's findings

All adversary findings live in `armada/ledgers/fix-global-link/ADVERSARIAL_REVIEW.md`. Writers: **adversary** (create
...
Format, exactly:
    ...
    Expected: ...
    Actual: ...
    Screenshot: armada/screenshots/fix-global-link/adv-001.png (optional)

    Disposition: PENDING

The orchestrator replaces PENDING with either `ACCEPTED -> DEF-NNN` or `REJECTED - reason`.
Accepted findings are reproduced and filed in armada/ledgers/fix-global-link/DEFECTS.md by qa. No entry may remain PENDING
