...
- End-to-end tests live under `armada/e2e/wezterm-baseline/`. Only qa writes there.
- Screenshots live under `armada/screenshots/wezterm-baseline/`.
...
## armada/ledgers/wezterm-baseline/DEFECTS.md — the defect ledger

All defects live in `armada/ledgers/wezterm-baseline/DEFECTS.md`, one entry per defect, newest
...
Format, exactly:
    ...
    Screenshot: armada/screenshots/wezterm-baseline/def-001.png (optional)
...
## armada/ledgers/wezterm-baseline/ADVERSARIAL_REVIEW.md — the adversary's findings

All adversary findings live in `armada/ledgers/wezterm-baseline/ADVERSARIAL_REVIEW.md`. Writers: **adversary** (create
...
Format, exactly:
    ...
    Expected: ...
    Actual: ...
    Screenshot: armada/screenshots/wezterm-baseline/adv-001.png (optional)

    Disposition: PENDING

The orchestrator replaces PENDING with either `ACCEPTED -> DEF-NNN` or `REJECTED - reason`.
Accepted findings are reproduced and filed in armada/ledgers/wezterm-baseline/DEFECTS.md by qa. No entry may remain PENDING
